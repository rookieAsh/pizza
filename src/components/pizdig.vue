  ...
  <div class="container">
    ...
    <el-dialog :visible.sync="dialogVisible" :before-close="handleClose" center>
      <div class="diaContent">
        ...
        <div class="buttonBox">
          <button class="confimBtn" @click="confimBtn()">确定</button>
